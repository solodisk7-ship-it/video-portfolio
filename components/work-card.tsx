    ...
    >
      <div className="relative aspect-square w-full shrink-0 bg-background">
        <Image
          ...
          className="absolute inset-0 h-full w-full object-contain transition-opacity duration-200 group-hover:opacity-80"
          preload={priority}
        />
        {work.videoKey && (
          <span
            className="absolute right-3 bottom-3 grid size-11 place-items-center border border-foreground/15 bg-background/90 text-foreground backdrop-blur-sm transition-colors group-hover:border-foreground/40"
            aria-hidden="true"
          >
            <Play
