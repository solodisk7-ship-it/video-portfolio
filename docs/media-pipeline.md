...
web-MP4 при экспорте или кодировании. Используйте согласованный текст или знак с
непрозрачностью 45–60% и отступом от края. Не добавляйте watermark в master-файл.

Lightbox не накладывает дополнительный CSS-watermark, чтобы маркировка не
дублировалась. Он скрывает обычную кнопку скачивания и блокирует контекстное меню.
Эти меры затрудняют случайное копирование, но не являются DRM и не могут запретить
извлечение данных из браузера или запись экрана.
